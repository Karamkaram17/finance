import{g as Q,i as E,k as N,l as O,sa as q,ta as g,va as A,ya as P}from"./chunk-2YSVRUZ5.js";import{Ba as o,Fb as z,Ma as b,Na as C,Q as v,Qa as $,R as h,Sa as r,W as T,Yb as B,Za as i,ab as k,bb as I,ea as p,fb as u,gb as d,hb as x,ib as M,jb as w,ob as l,pb as D,qb as F,rb as f,tb as m,ub as y,yb as j,zb as S}from"./chunk-OAQCL6FN.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
